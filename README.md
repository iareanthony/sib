...
| Service | URL | Stack |
|---------|-----|-------|
| **Grafana** | http://localhost:4000 | Both |
...
The demo spins up a temporary container and triggers various Falco rules. Watch your Grafana dashboards light up in real-time at http://localhost:4000.
...
1. Open Grafana at http://localhost:4000
